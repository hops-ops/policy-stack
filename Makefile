...
XRD_DIR := apis/policystacks
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
CONFIGURATION := $(XRD_DIR)/configuration.yaml
EXAMPLE_DEFAULT := examples/policystacks/standard.yaml
...
EXAMPLES := \
    examples/policystacks/minimal.yaml:: \
    examples/policystacks/standard.yaml::
...
render\:%:
	@example="examples/policystacks/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
